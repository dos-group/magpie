...
set $dir=/mnt/lustrefs/offline_tuning/video_server/wally053
set $eventrate=96
set $filesize=100m
set $nthreads=48
...
define fileset name=$passvidsname,path=$dir,size=$filesize,entries=$numpassivevids,dirwidth=20,prealloc=10,paralloc,reuse=$reuseit
